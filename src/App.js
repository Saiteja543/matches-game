...
class App extends Component {
  ...
  onClickImage = id => {
    ...
    const isMatching = randomImageId === id
    ...
    this.setState({
      randomImageId: imagesList[imageIndex].id,
      randomImageUrl: imagesList[imageIndex].imageUrl,
    })
  }
              ...
              <ul className="tabs-container">
                {tabsList.map(eachTab => (
                  <TabsList
                    ...
                    isTabInActive={activeTabId === eachTab.tabId}
                  />
                ))}
              </ul>
              <ul className="images-container">
                {getFilteredItems.map(eachImageItem => (
                  <ImagesList
